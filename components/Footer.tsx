...
export const Footer = () => {
  ...
  return (
    ...
    >
      <div>
        <div className="lg:flex-row flex-col flex  space-x-5  xl:space-x-16   px-6 lg:px-[50px] xl:px-[100px]">
          ...
          <div className="w-full lg:flex-row flex-col  flex justify-between">
            ...
            >
              <ul className="items-center  -mt-1 font-semibold justify-center  flex sm:space-x-8 md:space-y-0">
              ...
              <div className="w-full flex flex-col space-y-5">
                <div className="flex">
                  ...
                  >
                    <ul className="items-center -mt-1 font-semibold justify-center  flex sm:space-x-8 md:space-y-0">
                      ...
                      >
                        <Link href="/terms-condition" className={`text-[16px] `}>
                          Terms & Service
                        </Link>
                      </li>
                      <li
                ...
                <div className="flex">
                  <div
                    className={` flex w-full justify-center  lg:justify-end  py-2 pb-3  md:pb-0 md:mt-0 `}
                  >
                    <ul className=" -mt-1 font-semibold justify-center  lg:justify-end space-y-0   flex sm:space-x-5 ">
